...
public class HelpActionShowDocumentation extends NodeAction {
    ...
    protected boolean enable(Node[] nodes) {
        ...
        Project project = projects.size() == 1 ? projects.get(0) : null;
        ...
        return (executor != null && provider != null && projects.size() == 1);
    }
    ...
    void executeInstall(@NotNull INodeJSEnvironment pNodeJsEnvironment, @NotNull INodeJSExecutor pExecutor, @Nullable ProgressHandle pHandle, @NotNull String pPackage, int pPackageNumber) {
        try {
            ...
            if (!verifyPackageInstallation(pNodeJsEnvironment, pExecutor, pPackage)) {
     ...
     */
    private String moveAndOverwriteJSDocContent(@NotNull String pPath, int pPort, String pProjectName, String pDesignerNodePath) throws IOException {
        ...
        //includeArray.add(pPath + "/process/");
    ...
    protected void executeHttpServer(ProgressHandle pHandle, INodeJSEnvironment pNodeJsEnv, INodeJSExecutor pNodeJsExecutor, String pJSDocPath, String pDesignerNodePath, int pPort) throws IOException {
        pHandle.progress("Opening HTTP-Server", 17);
